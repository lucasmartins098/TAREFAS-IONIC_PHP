...
var DateTime = (function (_super) {
    ...
    function DateTime(form, config, elementRef, renderer, item, _pickerCtrl) {
        ...
        _this._locale = {};
        /**
         * @input {string} The text to display on the picker's cancel button. Default: `Cancelar`.
         */
        _this.cancelText = 'Cancelar';
        /**
         * @input {string} The text to display on the picker's "Done" button. Default: `Confirmar`.
         */
        _this.doneText = 'Confirmar';
        /**
