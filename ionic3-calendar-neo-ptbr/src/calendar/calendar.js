...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.colorCheck = function (year, month, date) {
        var i = 0, len = this.events.length;
        for (; i < len; i++) {
            if (this.events[i].year == year && this.events[i].month == month && this.events[i].date == date) {
    ...
    //Check Custom prop
    Calendar.prototype.CustomCheck = function (year, month, date,param) {
    ...
    Calendar.prototype.createMonth = function (year, month) {
            ...
            for (var i = 0; i < firstDay; i++) {
                if (month === 0) {
                    this.dateArray.push({
                        ...
                        isToday: false,
                        isSelect: false,
                        description: (this.CustomCheck(year,11,lastMonthStart+1,"description")),
                        color: (this.colorCheck(year,11,lastMonthStart+1)),
                        time: (this.CustomCheck(year,11,lastMonthStart+1,"time")),
                    ...
                    this.dateArray.push({
                        ...
                        isToday: false,
                        isSelect: false,
                        description:(this.CustomCheck(year,month-1,lastMonthStart+i,"description")),
                        color: (this.colorCheck(year,month-1,lastMonthStart+i)),
                        time: (this.CustomCheck(year,month-1,lastMonthStart+i,"time")),
        ...
        for (var i = 0; i < monthDays; i++) {
            this.dateArray.push({
                ...
                isToday: false,
                isSelect: false,
                description: (this.CustomCheck(year,month,i+1,"description")),
                color: (this.colorCheck(year,month,i+1)),
                time: (this.CustomCheck(year,month,i+1,"time")),
            ...
            for (var i = 0; i < nextMonthAdd; i++) {
                if (month === 11) {
                    this.dateArray.push({
                        ...
                        isToday: false,
                        isSelect: false,
                        description: (this.CustomCheck(year,0,i+1,"description")),
                        color: (this.colorCheck(year,0,i+1)),
                        time: (this.CustomCheck(year,0,i+1,"time")),
                    ...
                    this.dateArray.push({
                        ...
                        isToday: false,
                        isSelect: false,
                        description: (this.CustomCheck(year,month+1,i+1,"description")),
                        color: (this.colorCheck(year,month+1,i+1)),
                        time: (this.CustomCheck(year,month+1,i+1,"time")),
